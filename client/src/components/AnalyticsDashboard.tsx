...
const sampleConversionData: ConversionMetric[] = [
  { period: 'Week 1', visitors: 2500, leads: 120, conversions: 18, conversionRate: 15 },
  { period: 'Week 2', visitors: 3200, leads: 180, conversions: 24, conversionRate: 13.3 },
  { period: 'Week 3', visitors: 2800, leads: 150, conversions: 21, conversionRate: 14 },
  { period: 'Week 4', visitors: 4100, leads: 230, conversions: 35, conversionRate: 15.2 },
];
...
const periodOptions = ['Last 7 days', 'Last 30 days', 'Last 90 days', 'Year to date', 'All time'];
    ...
    return (
      <section className="py-20 bg-[#121212]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-poppins font-bold mb-4">Analytics Dashboard</h2>
          <p className="text-xl text-gray-300 mb-8">Please login to view the analytics dashboard.</p>
        </div>
      </section>
    );
  }
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Track your marketing performance and conversion metrics to optimize your fitness business.
          </p>
        </motion.div>
          ...
          <TabsContent value="conversions" className={activeTab === 'conversions' ? 'block' : 'hidden'}>
            <Card className="bg-[#1A1A1A] border-[#333]">
              <CardHeader>
                ...
                <CardDescription>Track the performance of your conversion funnel</CardDescription>
              </CardHeader>
              <CardContent>
                {loading ? (
                  ...
                  <div className="h-80 bg-[#222] rounded-lg p-4">
                    ...
                    <div className="h-full flex items-center justify-center">
                      <p className="text-gray-400">Interactive chart would appear here in production</p>
                    </div>
                  </div>
                )}
                        ...
                        <div className="space-y-2">
                          <div>
                            <div className="flex justify-between text-sm mb-1">
                              ...
                              <span>{((item.leads / item.visitors) * 100).toFixed(1)}%</span>
                            </div>
                            <Progress value={(item.leads / item.visitors) * 100} className="h-2 bg-[#333]" />
                          </div>
                          <div>
                            <div className="flex justify-between text-sm mb-1">
                            ...
                            <Progress value={item.conversionRate} className="h-2 bg-[#333]" />
                          </div>
                        </div>
                      </CardContent>
                    </Card>
              ...
              <CardContent>
                {loading ? (
                  ...
                  <div className="h-80 bg-[#222] rounded-lg p-4">
                    {/* Recharts would be used here in a real implementation */}
                    <div className="h-full flex items-center justify-center">
                      <p className="text-gray-400">Interactive pie chart would appear here in production</p>
                    </div>
                  </div>
                )}
                      ...
                      <div key={source.source} className="flex items-center">
                        ...
                        <div className="flex-1">
                          ...
                          <Progress 
                            ...
                            className="h-2"
                            style={{ background: `linear-gradient(to right, ${source.color}30, ${source.color}60)` }}
                          />
                        </div>
                      </div>
                    ))}
          ...
          <TabsContent value="pages" className={activeTab === 'pages' ? 'block' : 'hidden'}>
            <Card className="bg-[#1A1A1A] border-[#333]">
              <CardHeader>
                ...
                <CardDescription>Track which pages are most engaging</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <table className="w-full">
                    <thead className="bg-[#222]">
                      <tr>
                        ...
                        <th className="py-3 px-4 text-left">Avg. Time on Page</th>
                        <th className="py-3 px-4 text-left">% of Total Views</th>
                      </tr>
                    </thead>
                    <tbody>
                      {pageViewData.map((page, index) => {
                        const totalViews = pageViewData.reduce((sum, p) => sum + p.views, 0);
                        const percentOfTotal = ((page.views / totalViews) * 100).toFixed(1);
                        
                        return (
                          <tr key={index} className={index % 2 === 0 ? 'bg-[#1A1A1A]' : 'bg-[#222]'}>
                ...
                <div className="text-center text-sm text-gray-400">
                  <p>
                    This dashboard shows example data. In a production environment, it would display real-time analytics from your gym's website.
                  </p>
                </div>
              </CardContent>
            </Card>
